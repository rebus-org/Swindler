...
public static class AppConfig
{
    ...
    class ChangedAppConfigContext : IDisposable
    {
        ...
        static void SetPrivateFields()
        {
            ...
            var initStateField = typeof(ConfigurationManager).GetField("s_initState", privateStatic);
            ...
            var configSystemField = typeof(ConfigurationManager).GetField("s_configSystem", privateStatic);
            ...
            var currentField = clientConfigPathsType.GetField("s_current", privateStatic);
